...
public interface ChatController {
    BaseResponse<ChatRoom> createRoom(ChatRoomRequest room, HttpServletRequest request);

    BaseResponse<List<ChatRoom>> getRooms(HttpServletRequest request);

    BaseResponse<PageableResponse<ChatMessage>> getMessages(Long roomId, Pageable pageable, HttpServletRequest request);
}
